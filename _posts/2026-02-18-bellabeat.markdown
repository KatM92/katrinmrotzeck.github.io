...
description: "For this case study, I analyzed smart device fitness data to unlock growth opportunities for Bellabeat. Key highlights include:<br><br>
  ...
  • <b>Outcome:</b> Recommended a 'Low Power' mode and evening push notifications to increase user engagement during the 'Nighttime Gap'.<br><br>
  <a href='https://www.kaggle.com/code/katrinmrotzeck/bellabeat-case-study-in-r' target='_blank' class='btn btn-default'>View Full Story on Kaggle</a>"
---
